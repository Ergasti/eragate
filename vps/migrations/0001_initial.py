...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Flavor'
        db.create_table(u'vps_flavor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name_en', self.gf('django.db.models.fields.CharField')(max_length=100, null=True)),
            ('name_ar', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True)),
            ('ram_mb', self.gf('django.db.models.fields.IntegerField')()),
            ('disk_gb', self.gf('django.db.models.fields.IntegerField')()),
            ('flavor_uuid', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, blank=True)),
        ))
        db.send_create_signal(u'vps', ['Flavor'])

        # Adding model 'Plan'
        db.create_table(u'vps_plan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('months', self.gf('django.db.models.fields.IntegerField')()),
            ('flavor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vps.Flavor'])),
            ('amount_currency', self.gf('djmoney.models.fields.CurrencyField')(default='EGP')),
            ('amount', self.gf('djmoney.models.fields.MoneyField')(max_digits=10, decimal_places=2, default_currency='EGP')),
        ))
        db.send_create_signal(u'vps', ['Plan'])

        # Adding model 'OSImage'
        db.create_table(u'vps_osimage', (
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
        ))
        db.send_create_signal(u'vps', ['OSImage'])

        # Adding model 'Order'
        db.create_table(u'vps_order', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('placed_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('fulfilled_at', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True)),
            ('fulfilled', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('subdomain', self.gf('django.db.models.fields.CharField')(unique=True, max_length=20)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vps.Plan'])),
            ('os_image', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vps.OSImage'], null=True, blank=True)),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'vps', ['Order'])

        # Adding model 'VPS'
        db.create_table(u'vps_vps', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vps.Plan'])),
            ('instance_uuid', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('ip', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True)),
            ('subdomain', self.gf('django.db.models.fields.CharField')(max_length=20, unique=True, null=True, blank=True)),
            ('order', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['vps.Order'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal(u'vps', ['VPS'])

        # Adding model 'UserProfile'
        db.create_table(u'vps_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('is_verfied', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ...
            ('sms_code', self.gf('django.db.models.fields.CharField')(max_length=5, null=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=400, null=True)),
            ('rating', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            ('phone_is_verified', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'vps', ['UserProfile'])


    def backwards(self, orm):
        # Deleting model 'Flavor'
        db.delete_table(u'vps_flavor')

        # Deleting model 'Plan'
        db.delete_table(u'vps_plan')

        # Deleting model 'OSImage'
        db.delete_table(u'vps_osimage')

        # Deleting model 'Order'
        db.delete_table(u'vps_order')

        # Deleting model 'VPS'
        db.delete_table(u'vps_vps')

        # Deleting model 'UserProfile'
        db.delete_table(u'vps_userprofile')
